...
next_state = {
    ...
    RUN:    {RU: IDLE, LU: IDLE, RD: IDLE, LD: IDLE, ATTK: ATTACK, ATTKU: IDLE, UD: IDLE, UU: IDLE, DD: IDLE, DU: IDLE, CAND: IDLE, CANU: IDLE, HEALD: IDLE, HEALU: IDLE, POWD: IDLE, POWU: IDLE},
